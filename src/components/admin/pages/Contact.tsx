// src/components/admin/pages/ContactInquiries.tsx
'use client';
  ...
  return (
    <>
      <div className="mb-8">
        ...
        <p className="text-gray-600">Manage The contact queries by responding to them.</p>
      </div>
